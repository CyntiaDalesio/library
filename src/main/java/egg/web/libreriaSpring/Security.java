...
package egg.web.libreriaSpring;
...
@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) //permite poder autorizar las url
public class Security extends WebSecurityConfigurerAdapter{
    ...
    // userdatailservice -> loadbyusername metodo que vamos a sobreescribir -> usuarioservicio
    @Autowired
